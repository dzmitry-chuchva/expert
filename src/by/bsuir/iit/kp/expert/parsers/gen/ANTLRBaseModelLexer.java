// $ANTLR 2.7.7 (2006-11-01): "ANTLRBaseModelParser.g" -> "ANTLRBaseModelLexer.java"$
...
public class ANTLRBaseModelLexer extends antlr.CharScanner implements ANTLRBaseModelParserTokenTypes, TokenStream
 {
public ANTLRBaseModelLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ANTLRBaseModelLexer(Reader in) {
	this(new CharBuffer(in));
}
public ANTLRBaseModelLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ANTLRBaseModelLexer(LexerSharedInputState state) {
	super(state);
