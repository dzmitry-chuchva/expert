// $ANTLR 2.7.7 (2006-11-01): "expandedANTLRModelParser.g" -> "ANTLRModelLexer.java"$
...
public class ANTLRModelLexer extends antlr.CharScanner implements ANTLRModelLexerTokenTypes, TokenStream
 {
public ANTLRModelLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ANTLRModelLexer(Reader in) {
	this(new CharBuffer(in));
}
public ANTLRModelLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ANTLRModelLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = false;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("if", this), new Integer(9));
	literals.put(new ANTLRHashString("target", this), new Integer(44));
	literals.put(new ANTLRHashString("name", this), new Integer(42));
	literals.put(new ANTLRHashString("assertion", this), new Integer(41));
	literals.put(new ANTLRHashString("symbol", this), new Integer(39));
	literals.put(new ANTLRHashString("attribute", this), new Integer(35));
	literals.put(new ANTLRHashString("number", this), new Integer(34));
	literals.put(new ANTLRHashString("rule", this), new Integer(43));
	literals.put(new ANTLRHashString("from", this), new Integer(36));
	literals.put(new ANTLRHashString("value", this), new Integer(40));
...
tryAgain:
	...
	protected final void mDUMMY(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
	...
	public final void mINT_VALUE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = INT_VALUE;
		int _saveIndex;
	...
	public final void mCOMMENT_STRING(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = COMMENT_STRING;
		int _saveIndex;
