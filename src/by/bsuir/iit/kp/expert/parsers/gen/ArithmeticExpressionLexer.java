// $ANTLR 2.7.7 (2006-11-01): "expandedArithmeticExpressionParser.g" -> "ArithmeticExpressionLexer.java"$
...
public class ArithmeticExpressionLexer extends antlr.CharScanner implements ArithmeticExpressionLexerTokenTypes, TokenStream
 {
public ArithmeticExpressionLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ArithmeticExpressionLexer(Reader in) {
	this(new CharBuffer(in));
}
public ArithmeticExpressionLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ArithmeticExpressionLexer(LexerSharedInputState state) {
	super(state);
