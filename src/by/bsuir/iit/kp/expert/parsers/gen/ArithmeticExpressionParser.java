// $ANTLR 2.7.7 (2006-11-01): "expandedArithmeticExpressionParser.g" -> "ArithmeticExpressionParser.java"$
...
public class ArithmeticExpressionParser extends antlr.LLkParser       implements ArithmeticExpressionParserTokenTypes
 {

	private ArithmeticFunctionsFactory afactory = ArithmeticFunctionsFactory.getInstance();

protected ArithmeticExpressionParser(TokenBuffer tokenBuf, int k) {
  super(tokenBuf,k);
  tokenNames = _tokenNames;
}

public ArithmeticExpressionParser(TokenBuffer tokenBuf) {
  this(tokenBuf,1);
}

protected ArithmeticExpressionParser(TokenStream lexer, int k) {
  super(lexer,k);
  tokenNames = _tokenNames;
}

public ArithmeticExpressionParser(TokenStream lexer) {
  this(lexer,1);
}

public ArithmeticExpressionParser(ParserSharedInputState state) {
  super(state,1);
  tokenNames = _tokenNames;
}
