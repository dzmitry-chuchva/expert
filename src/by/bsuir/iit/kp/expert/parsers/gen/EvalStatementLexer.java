// $ANTLR 2.7.7 (2006-11-01): "expandedeval.g" -> "EvalStatementLexer.java"$
...
public class EvalStatementLexer extends antlr.CharScanner implements EvalStatementLexerTokenTypes, TokenStream
 {
public EvalStatementLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public EvalStatementLexer(Reader in) {
	this(new CharBuffer(in));
}
public EvalStatementLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public EvalStatementLexer(LexerSharedInputState state) {
	super(state);
