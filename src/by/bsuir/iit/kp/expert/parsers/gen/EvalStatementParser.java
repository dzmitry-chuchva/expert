// $ANTLR 2.7.7 (2006-11-01): "expandedeval.g" -> "EvalStatementParser.java"$
...
public class EvalStatementParser extends antlr.LLkParser       implements EvalStatementParserTokenTypes
 {

protected EvalStatementParser(TokenBuffer tokenBuf, int k) {
  super(tokenBuf,k);
  tokenNames = _tokenNames;
}

public EvalStatementParser(TokenBuffer tokenBuf) {
  this(tokenBuf,1);
}

protected EvalStatementParser(TokenStream lexer, int k) {
  super(lexer,k);
  tokenNames = _tokenNames;
}

public EvalStatementParser(TokenStream lexer) {
  this(lexer,1);
}

public EvalStatementParser(ParserSharedInputState state) {
  super(state,1);
  tokenNames = _tokenNames;
}
