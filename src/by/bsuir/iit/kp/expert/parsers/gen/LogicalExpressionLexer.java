// $ANTLR 2.7.7 (2006-11-01): "expandedLogicalExpressionParser.g" -> "LogicalExpressionLexer.java"$
...
public class LogicalExpressionLexer extends antlr.CharScanner implements LogicalExpressionLexerTokenTypes, TokenStream
 {
public LogicalExpressionLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public LogicalExpressionLexer(Reader in) {
	this(new CharBuffer(in));
}
public LogicalExpressionLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public LogicalExpressionLexer(LexerSharedInputState state) {
	super(state);
