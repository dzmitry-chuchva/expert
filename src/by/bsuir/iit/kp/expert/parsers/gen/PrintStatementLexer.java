// $ANTLR 2.7.7 (2006-11-01): "expandedprint.g" -> "PrintStatementLexer.java"$
...
public class PrintStatementLexer extends antlr.CharScanner implements PrintStatementLexerTokenTypes, TokenStream
 {
public PrintStatementLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public PrintStatementLexer(Reader in) {
	this(new CharBuffer(in));
}
public PrintStatementLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public PrintStatementLexer(LexerSharedInputState state) {
	super(state);
