// $ANTLR 2.7.7 (2006-11-01): "expandedreset.g" -> "ResetStatementLexer.java"$
...
public class ResetStatementLexer extends antlr.CharScanner implements ResetStatementLexerTokenTypes, TokenStream
 {
public ResetStatementLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ResetStatementLexer(Reader in) {
	this(new CharBuffer(in));
}
public ResetStatementLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ResetStatementLexer(LexerSharedInputState state) {
	super(state);
