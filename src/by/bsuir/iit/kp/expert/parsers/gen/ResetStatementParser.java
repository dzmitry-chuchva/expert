// $ANTLR 2.7.7 (2006-11-01): "expandedreset.g" -> "ResetStatementParser.java"$
...
public class ResetStatementParser extends antlr.LLkParser       implements ResetStatementParserTokenTypes
 {
...
protected ResetStatementParser(TokenBuffer tokenBuf, int k) {
  super(tokenBuf,k);
  tokenNames = _tokenNames;
}

public ResetStatementParser(TokenBuffer tokenBuf) {
  this(tokenBuf,1);
}

protected ResetStatementParser(TokenStream lexer, int k) {
  super(lexer,k);
  tokenNames = _tokenNames;
}

public ResetStatementParser(TokenStream lexer) {
  this(lexer,1);
}

public ResetStatementParser(ParserSharedInputState state) {
  super(state,1);
  tokenNames = _tokenNames;
}
